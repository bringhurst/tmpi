...
!
      ...
      PARAMETER (MPI_MAX_PROCESSOR_NAME=1024)
...
!
      ...
      PARAMETER (MPI_LXOR=9,MPI_BXOR=10,MPI_MINLOC=11)
      PARAMETER (MPI_MAXLOC=12, MPI_OP_NULL=0)
!
...
! 
!     $Id: mpiof.h.in,v 1.2 1998/06/02 19:00:14 thakur Exp $    
! 
